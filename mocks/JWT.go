...
func (_m *JWT) Generate(username string, role uint) string {
...
func (_c *JWT_Generate_Call) Run(run func(username string, role uint)) *JWT_Generate_Call {
...
func (_c *JWT_Generate_Call) RunAndReturn(run func(string, uint) string) *JWT_Generate_Call {
	_c.Call.Return(run)
	return _c
}
...
// ValidateAdmin provides a mock function with given fields: c
func (_m *JWT) ValidateAdmin(c *fiber.Ctx) error {
	ret := _m.Called(c)
...
// JWT_ValidateAdmin_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ValidateAdmin'
type JWT_ValidateAdmin_Call struct {
	*mock.Call
}

// ValidateAdmin is a helper method to define mock.On call
//   - c *fiber.Ctx
func (_e *JWT_Expecter) ValidateAdmin(c interface{}) *JWT_ValidateAdmin_Call {
	return &JWT_ValidateAdmin_Call{Call: _e.mock.On("ValidateAdmin", c)}
}

func (_c *JWT_ValidateAdmin_Call) Run(run func(c *fiber.Ctx)) *JWT_ValidateAdmin_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*fiber.Ctx))
	})
	return _c
...
func (_c *JWT_ValidateAdmin_Call) Return(_a0 error) *JWT_ValidateAdmin_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *JWT_ValidateAdmin_Call) RunAndReturn(run func(*fiber.Ctx) error) *JWT_ValidateAdmin_Call {
	_c.Call.Return(run)
	return _c
}
